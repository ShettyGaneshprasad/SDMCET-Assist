...
class DCHEMtoDMATHS extends StatefulWidget {
  _DCHEMtoDMATHS createState() => new _DCHEMtoDMATHS();
}

class _DCHEMtoDMATHS extends State<DCHEMtoDMATHS> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("DCHEMtoDMATHS");
