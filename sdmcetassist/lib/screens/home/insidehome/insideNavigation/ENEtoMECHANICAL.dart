...
class ENEtoMECHANICAL extends StatefulWidget {
  _ENEtoMECHANICAL createState() => new _ENEtoMECHANICAL();
}

class _ENEtoMECHANICAL extends State<ENEtoMECHANICAL> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENEtoCHEMICAL");
