...
class ENCtoDCHEM extends StatefulWidget {
  _ENCtoDCHEM createState() => new _ENCtoDCHEM();
}

class _ENCtoDCHEM extends State<ENCtoDCHEM> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENCtoDCHEM");
