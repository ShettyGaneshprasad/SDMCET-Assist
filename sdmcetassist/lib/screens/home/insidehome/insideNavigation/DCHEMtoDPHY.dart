...
class DCHEMtoDPHY extends StatefulWidget {
  _DCHEMtoDPHY createState() => new _DCHEMtoDPHY();
}

class _DCHEMtoDPHY extends State<DCHEMtoDPHY> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("DCHEMtoDPHY");
