...
class ENCtoCHEMICAL extends StatefulWidget {
  _ENCtoCHEMICAL createState() => new _ENCtoCHEMICAL();
}

class _ENCtoCHEMICAL extends State<ENCtoCHEMICAL> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENCtoCHEMICAL");
