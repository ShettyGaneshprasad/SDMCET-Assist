...
class CHEMtoDPHY extends StatefulWidget {
  _CHEMtoDPHY createState() => new _CHEMtoDPHY();
}

class _CHEMtoDPHY extends State<CHEMtoDPHY> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("CHEMtoDPHY");
