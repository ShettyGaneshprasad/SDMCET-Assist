...
class ENCtoDMATH extends StatefulWidget {
  _ENCtoDMATH createState() => new _ENCtoDMATH();
}

class _ENCtoDMATH extends State<ENCtoDMATH> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENCtoDMATH");
