...
class CHEMtoDCHEM extends StatefulWidget {
  _CHEMtoDCHEM createState() => new _CHEMtoDCHEM();
}

class _CHEMtoDCHEM extends State<CHEMtoDCHEM> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("CHEMtoDCHEM");
