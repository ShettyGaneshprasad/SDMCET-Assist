...
class CIVILtoDPHY extends StatefulWidget {
  _CIVILtoDPHY createState() => new _CIVILtoDPHY();
}

class _CIVILtoDPHY extends State<CIVILtoDPHY> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("CIVILtoDPHY");
