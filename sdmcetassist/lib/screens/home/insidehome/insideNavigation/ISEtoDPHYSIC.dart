...
class ISEtoDPHYSIC extends StatefulWidget {
  _ISEtoDPHYSIC createState() => new _ISEtoDPHYSIC();
}

class _ISEtoDPHYSIC extends State<ISEtoDPHYSIC> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ISEtoDPHYSIC");
