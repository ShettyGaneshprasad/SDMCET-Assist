...
class MECHtoDPHYSIC extends StatefulWidget {
  _MECHtoDPHYSIC createState() => new _MECHtoDPHYSIC();
}

class _MECHtoDPHYSIC extends State<MECHtoDPHYSIC> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("MECHtoDPHYSIC");
