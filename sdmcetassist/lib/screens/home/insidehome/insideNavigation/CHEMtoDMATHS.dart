...
class CHEMtoDMATHS extends StatefulWidget {
  _CHEMtoDMATHS createState() => new _CHEMtoDMATHS();
}

class _CHEMtoDMATHS extends State<CHEMtoDMATHS> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("CHEMtoDMATHS");
