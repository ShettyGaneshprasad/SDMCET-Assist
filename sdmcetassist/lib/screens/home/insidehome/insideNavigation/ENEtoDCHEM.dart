...
class ENEtoDCHEM extends StatefulWidget {
  _ENEtoDCHEM createState() => new _ENEtoDCHEM();
}

class _ENEtoDCHEM extends State<ENEtoDCHEM> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENEtoDCHEM");
