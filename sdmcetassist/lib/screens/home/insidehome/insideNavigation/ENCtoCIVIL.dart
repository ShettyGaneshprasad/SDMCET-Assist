...
class ENCtoCIVIL extends StatefulWidget {
  _ENCtoCIVIL createState() => new _ENCtoCIVIL();
}

class _ENCtoCIVIL extends State<ENCtoCIVIL> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENCtoCIVIL");
