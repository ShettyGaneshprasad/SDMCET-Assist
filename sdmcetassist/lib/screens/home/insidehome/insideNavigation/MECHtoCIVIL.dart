...
class MECHtoCIVIL extends StatefulWidget {
  _MECHtoCIVIL createState() => new _MECHtoCIVIL();
}

class _MECHtoCIVIL extends State<MECHtoCIVIL> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("MECHtoCIVIL");
