...
class ISEtoMECHANICAL extends StatefulWidget {
  _ISEtoMECHANICAL createState() => new _ISEtoMECHANICAL();
}

class _ISEtoMECHANICAL extends State<ISEtoMECHANICAL> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ISEtoMECHANICAL");
