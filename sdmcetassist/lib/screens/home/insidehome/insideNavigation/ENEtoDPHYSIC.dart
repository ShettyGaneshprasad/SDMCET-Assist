...
class ENEtoDPHYSIC extends StatefulWidget {
  _ENEtoDPHYSIC createState() => new _ENEtoDPHYSIC();
}

class _ENEtoDPHYSIC extends State<ENEtoDPHYSIC> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENEtoDPHYSIC");
