...
class CIVILtoDMATHS extends StatefulWidget {
  _CIVILtoDMATHS createState() => new _CIVILtoDMATHS();
}

class _CIVILtoDMATHS extends State<CIVILtoDMATHS> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("CIVILtoDMATHS");
