...
class DPHYtoDMATHS extends StatefulWidget {
  _DPHYtoDMATHS createState() => new _DPHYtoDMATHS();
}

class _DPHYtoDMATHS extends State<DPHYtoDMATHS> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("DPHYtoDMATHS");
