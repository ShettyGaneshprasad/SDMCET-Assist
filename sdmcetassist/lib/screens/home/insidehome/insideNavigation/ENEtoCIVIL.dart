...
class ENEtoCIVIL extends StatefulWidget {
  _ENEtoCIVIL createState() => new _ENEtoCIVIL();
}

class _ENEtoCIVIL extends State<ENEtoCIVIL> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENEtoCIVIL");
