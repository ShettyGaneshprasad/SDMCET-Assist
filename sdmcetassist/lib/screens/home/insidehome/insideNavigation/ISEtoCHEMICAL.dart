...
class ISEtoCHEMICAL extends StatefulWidget {
  _ISEtoCHEMICAL createState() => new _ISEtoCHEMICAL();
}

class _ISEtoCHEMICAL extends State<ISEtoCHEMICAL> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ISEtoCHEMICAL");
