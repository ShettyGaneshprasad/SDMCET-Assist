...
class CIVILtoDCHEM extends StatefulWidget {
  _CIVILtoDCHEM createState() => new _CIVILtoDCHEM();
}

class _CIVILtoDCHEM extends State<CIVILtoDCHEM> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("CIVILtoDCHEM");
