...
class ENEtoDMATH extends StatefulWidget {
  _ENEtoDMATH createState() => new _ENEtoDMATH();
}

class _ENEtoDMATH extends State<ENEtoDMATH> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENEtoDMATH");
