...
class ISEtoDMATHS extends StatefulWidget {
  _ISEtoDMATHS createState() => new _ISEtoDMATHS();
}

class _ISEtoDMATHS extends State<ISEtoDMATHS> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ISEtoDMATHS");
