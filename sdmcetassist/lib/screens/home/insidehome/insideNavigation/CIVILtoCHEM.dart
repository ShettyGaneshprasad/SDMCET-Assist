...
class CIVILtoCHEM extends StatefulWidget {
  _CIVILtoCHEM createState() => new _CIVILtoCHEM();
}

class _CIVILtoCHEM extends State<CIVILtoCHEM> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("CIVILtoCHEM");
