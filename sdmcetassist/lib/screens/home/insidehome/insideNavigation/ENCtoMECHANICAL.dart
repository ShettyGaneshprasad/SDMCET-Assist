...
class ENCtoMECHANICAL extends StatefulWidget {
  _ENCtoMECHANICAL createState() => new _ENCtoMECHANICAL();
}

class _ENCtoMECHANICAL extends State<ENCtoMECHANICAL> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENCtoMECHANICAL");
