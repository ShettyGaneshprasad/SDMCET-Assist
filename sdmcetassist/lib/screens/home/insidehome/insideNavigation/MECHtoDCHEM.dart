...
class MECHtoDCHEM extends StatefulWidget {
  _MECHtoDCHEM createState() => new _MECHtoDCHEM();
}

class _MECHtoDCHEM extends State<MECHtoDCHEM> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("MECHtoDCHEM");
