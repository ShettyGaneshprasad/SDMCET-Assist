...
class MECHtoDMATHS extends StatefulWidget {
  _MECHtoDMATHS createState() => new _MECHtoDMATHS();
}

class _MECHtoDMATHS extends State<MECHtoDMATHS> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("MECHtoDMATHS");
