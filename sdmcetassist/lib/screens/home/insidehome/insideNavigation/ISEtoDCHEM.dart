...
class ISEtoDCHEM extends StatefulWidget {
  _ISEtoDCHEM createState() => new _ISEtoDCHEM();
}

class _ISEtoDCHEM extends State<ISEtoDCHEM> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ISEtoDCHEM");
