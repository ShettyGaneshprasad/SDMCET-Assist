...
class ENCtoDPHY extends StatefulWidget {
  _ENCtoDPHY createState() => new _ENCtoDPHY();
}

class _ENCtoDPHY extends State<ENCtoDPHY> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ENCtoDPHY");
