...
class ISEtoCIVIL extends StatefulWidget {
  _ISEtoCIVIL createState() => new _ISEtoCIVIL();
}

class _ISEtoCIVIL extends State<ISEtoCIVIL> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("ISEtoCIVIL");
