...
class CSEtoMECH extends StatefulWidget {
  _CSEtoMECH createState() => new _CSEtoMECH();
}

class _CSEtoMECH extends State<CSEtoMECH> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;

  final CollectionReference collectionReference =
      Firestore.instance.collection("CSEtoMECH");
