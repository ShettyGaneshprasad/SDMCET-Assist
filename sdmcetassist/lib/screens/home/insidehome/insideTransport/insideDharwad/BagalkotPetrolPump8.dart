...
class BagalkotPetrolPump8 extends StatefulWidget {
  _BagalkotPetrolPump8 createState() => new _BagalkotPetrolPump8();
}

class _BagalkotPetrolPump8 extends State<BagalkotPetrolPump8> {
