...
class BagalkotPetrolPump9 extends StatefulWidget {
  _BagalkotPetrolPump9 createState() => new _BagalkotPetrolPump9();
}

class _BagalkotPetrolPump9 extends State<BagalkotPetrolPump9> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            'Bagalkot Petrol Pump', /*style:TextStyle(color:Colors.black)*/
          ),
